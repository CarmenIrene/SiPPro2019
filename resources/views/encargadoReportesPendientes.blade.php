  ...
  <!--fin del div contenedor de datos y de la foto-->
   ...
   <form class="formTutorSolP" action="">
    <div class="tituloDatosTutor">
        <p>ALUMNOS CON REPORTES PENDIENTES DE AUTORIZAR</p>
        ...
        <div class="Tutor">
          <table class="tableSolPend" align="center" >
            <tbody>
              ...
              @foreach($reportesEncargado as $repEncarg)
              <tr>
                  <th>{{$repEncarg->claveUnica}}</th>
                  <th>{{$repEncarg->alumno->Nombre}}</th><!--Aqui va el nombre del alumno-->
                  <th>{{$repEncarg->numReporte}}</th>
                  <th><a href="/autorizaReportesEncargado/{{$encargado->rpe}}/{{$repEncarg->claveUnica}}">Ver</a></th>
                  <th><a href="/Elimina/{{$repEncarg->idRegistroPracticas}}">Eliminar</a></th>
              <tr></tr>
              </tr>
              @endforeach  
            </tbody>
