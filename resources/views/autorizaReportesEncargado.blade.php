...
<div class="container">
 ...
 <!-------------------Fin Datos Empresa---------------------------------------->
<!--Comentarios-->
    <div class="contenedorComentarioreporte" >
      <p>Comentarios</p>
    </div>
    <form method="POST" action="/GuardaAcreditacionReportesEncargado/{{$encargado->rpe}}/{{$alumno->claveUnica}}">
        @csrf
      <div class="comentario333">
        <div class="row rowComentario33" >
          <div class="col-3 columTel -sm" >
            <p>Fecha de autorización:</p>
          </div>
          <div class="col-9 inputTel -sm">
            <input class="form-control input-sm" name="fechaAutorizacion" id="fecha" value="{{$fechaAut}}">
          </div>     
        </div>
